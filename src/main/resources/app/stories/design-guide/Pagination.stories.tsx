...
/**
 * `Pagination` navigates between pages in a list or table.
 * Based on the `Pagination` pattern in the UI kit (Figma 94:1473).
 */
const meta: Meta<typeof Pagination> = {
  title: "Guia de Diseno/Patrones/Pagination",
